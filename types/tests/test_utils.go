...
var (
	...
	UservDenomtrace = transfertypes.DenomTrace{
		Path:      "transfer/channel-0",
		BaseDenom: "aserv",
	}
	UservIbcdenom = UservDenomtrace.IBCDenom()
	...
	AservDenomtrace = transfertypes.DenomTrace{
		Path:      "transfer/channel-0",
		BaseDenom: "aserv",
	}
	AservIbcdenom = AservDenomtrace.IBCDenom()
)
