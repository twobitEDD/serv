...
var (
	// MainnetMinGasPrices defines 20B aserv (or atserv) as the minimum gas price value on the fee market module.
	// See https://commonwealth.im/serv/discussion/5073-global-min-gas-price-value-for-cosmos-sdk-and-evm-transaction-choosing-a-value for reference
