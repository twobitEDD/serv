...
const (
	// MainnetChainID defines the Serv EIP155 chain ID for mainnet
	MainnetChainID = "serv_53970"
	// TestnetChainID defines the Serv EIP155 chain ID for testnet
	TestnetChainID = "serv_43970"
	// BaseDenom defines the Serv mainnet denomination
	BaseDenom = "aserv"
)

// IsMainnet returns true if the chain-id has the Serv mainnet EIP155 chain prefix.
func IsMainnet(chainID string) bool {
	return strings.HasPrefix(chainID, MainnetChainID)
}

// IsTestnet returns true if the chain-id has the Serv testnet EIP155 chain prefix.
