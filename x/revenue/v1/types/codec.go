...
const (
	// Amino names
	cancelRevenueName   = "serv/MsgCancelRevenue"
	registerRevenueName = "serv/MsgRegisterRevenue"
	updateRevenueName   = "serv/MsgUpdateRevenue"
	updateParamsName    = "serv/MsgUpdateParams"
)
