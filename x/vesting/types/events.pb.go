...
// source: serv/vesting/v1/events.proto
...
func init() {
	proto.RegisterType((*EventCreateClawbackVestingAccount)(nil), "serv.vesting.v1.EventCreateClawbackVestingAccount")
	proto.RegisterType((*EventClawback)(nil), "serv.vesting.v1.EventClawback")
	proto.RegisterType((*EventUpdateVestingFunder)(nil), "serv.vesting.v1.EventUpdateVestingFunder")
}

func init() { proto.RegisterFile("serv/vesting/v1/events.proto", fileDescriptor_48ea095c8e21d4cd) }
