...
const (
	// Amino names
	clawback                     = "serv/MsgClawback"
	createClawbackVestingAccount = "serv/MsgCreateClawbackVestingAccount"
	updateVestingFunder          = "serv/MsgUpdateVestingFunder"
	convertVestingAccount        = "serv/MsgConvertVestingAccount"
)
