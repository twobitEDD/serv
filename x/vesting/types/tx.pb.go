...
// source: serv/vesting/v1/tx.proto
...
func init() {
	proto.RegisterType((*MsgCreateClawbackVestingAccount)(nil), "serv.vesting.v1.MsgCreateClawbackVestingAccount")
	proto.RegisterType((*MsgCreateClawbackVestingAccountResponse)(nil), "serv.vesting.v1.MsgCreateClawbackVestingAccountResponse")
	proto.RegisterType((*MsgClawback)(nil), "serv.vesting.v1.MsgClawback")
	proto.RegisterType((*MsgClawbackResponse)(nil), "serv.vesting.v1.MsgClawbackResponse")
	proto.RegisterType((*MsgUpdateVestingFunder)(nil), "serv.vesting.v1.MsgUpdateVestingFunder")
	proto.RegisterType((*MsgUpdateVestingFunderResponse)(nil), "serv.vesting.v1.MsgUpdateVestingFunderResponse")
	proto.RegisterType((*MsgConvertVestingAccount)(nil), "serv.vesting.v1.MsgConvertVestingAccount")
	proto.RegisterType((*MsgConvertVestingAccountResponse)(nil), "serv.vesting.v1.MsgConvertVestingAccountResponse")
}

func init() { proto.RegisterFile("serv/vesting/v1/tx.proto", fileDescriptor_d5db113bc0c7240c) }
...
func (c *msgClient) CreateClawbackVestingAccount(ctx context.Context, in *MsgCreateClawbackVestingAccount, opts ...grpc.CallOption) (*MsgCreateClawbackVestingAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/serv.vesting.v1.Msg/CreateClawbackVestingAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) Clawback(ctx context.Context, in *MsgClawback, opts ...grpc.CallOption) (*MsgClawbackResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/serv.vesting.v1.Msg/Clawback", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateVestingFunder(ctx context.Context, in *MsgUpdateVestingFunder, opts ...grpc.CallOption) (*MsgUpdateVestingFunderResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/serv.vesting.v1.Msg/UpdateVestingFunder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ConvertVestingAccount(ctx context.Context, in *MsgConvertVestingAccount, opts ...grpc.CallOption) (*MsgConvertVestingAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/serv.vesting.v1.Msg/ConvertVestingAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateClawbackVestingAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/serv.vesting.v1.Msg/CreateClawbackVestingAccount",
	}
...
func _Msg_Clawback_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/serv.vesting.v1.Msg/Clawback",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_UpdateVestingFunder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/serv.vesting.v1.Msg/UpdateVestingFunder",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_ConvertVestingAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/serv.vesting.v1.Msg/ConvertVestingAccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "serv.vesting.v1.Msg",
	...
	Metadata: "serv/vesting/v1/tx.proto",
}
