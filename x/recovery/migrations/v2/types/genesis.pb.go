...
// source: serv/recovery/v1/genesis.proto
...
func init() {
	proto.RegisterType((*V2GenesisState)(nil), "serv.recovery.v1.V2GenesisState")
	proto.RegisterType((*V2Params)(nil), "serv.recovery.v1.V2Params")
}

func init() { proto.RegisterFile("serv/recovery/v1/genesis.proto", fileDescriptor_8a3e70cb61e26f25) }
