...
// The initial InflationDistribution can be calculated from the Serv Token
// Model like this:
...
func init() {
	proto.RegisterType((*InflationDistribution)(nil), "serv.inflation.v1.InflationDistribution")
	proto.RegisterType((*ExponentialCalculation)(nil), "serv.inflation.v1.ExponentialCalculation")
}
