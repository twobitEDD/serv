...
// ChainIDPrefix defines the default chain ID prefix for Serv test chains
var ChainIDPrefix = "serv_43970-"
...
func NewTestChain(t *testing.T, coord *ibcgotesting.Coordinator, chainID string) *ibcgotesting.TestChain {
	...
	amount := sdk.TokensFromConsensusPower(1, servtypes.PowerReduction)
