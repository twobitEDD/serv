...
// AppName defines the Ledger app used for signing. Serv uses the Ethereum app
...
var (
	...
	// LedgerDerivation defines the Serv Ledger Go derivation (Ethereum app with EIP-712 signing)
